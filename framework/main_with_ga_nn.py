...
C['log'] = False             # log=True will log the path and actions of the agent in a csv file in C['save_dir']
...
class Agent(object):
    ...
    def run(self, brain=0):
        ...
        while world_state.is_mission_running:
            ...
            action, returned_reward = self.act(current_reward, brain)    #TIM Added brain
            total_reward.append(returned_reward)
